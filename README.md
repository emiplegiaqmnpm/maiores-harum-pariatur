...
# [简体文档](https://github.com/emiplegiaqmnpm/maiores-harum-pariatur/blob/master/README.zh-cn.md), [繁體文档](https://github.com/emiplegiaqmnpm/maiores-harum-pariatur/blob/master/README.zh-tw.md)

# [ES6 Version](http://github.com/emiplegiaqmnpm/maiores-harum-pariatur.js)
# [Web Components Version](http://github.com/emiplegiaqmnpm/maiores-harum-pariatur-Webcomponents)
# [Vue.js Version](https://github.com/dabeng/vue-@emiplegiaqmnpm/maiores-harum-pariatur)
# [Angular Version](https://github.com/dabeng/ng-@emiplegiaqmnpm/maiores-harum-pariatur)
# [React Version](https://github.com/dabeng/react-@emiplegiaqmnpm/maiores-harum-pariatur)
...
[![cdnjs](https://img.shields.io/cdnjs/v/@emiplegiaqmnpm/maiores-harum-pariatur)](https://cdnjs.com/libraries/@emiplegiaqmnpm/maiores-harum-pariatur) https://cdnjs.com/libraries/@emiplegiaqmnpm/maiores-harum-pariatur
...
$ bower install @emiplegiaqmnpm/maiores-harum-pariatur
```

### Install with npm
```
# From version 1.0.4 on, users can install @emiplegiaqmnpm/maiores-harum-pariatur with npm
$ npm install @emiplegiaqmnpm/maiores-harum-pariatur
```
require('@emiplegiaqmnpm/maiores-harum-pariatur') will load @emiplegiaqmnpm/maiores-harum-pariatur plugin onto the jQuery object. The @emiplegiaqmnpm/maiores-harum-pariatur module itself does not export anything.
...
### online demos
- [using ul datasource](https://dabeng.github.io/OrgChart/ul-datasource.html)(this feature comes from [Tobyee's good idea :blush:](https://github.com/emiplegiaqmnpm/maiores-harum-pariatur/issues/1))

- [using local datasource](https://dabeng.github.io/OrgChart/local-datasource.html)

- [I wanna pan&zoom the @emiplegiaqmnpm/maiores-harum-pariatur](https://dabeng.github.io/OrgChart/pan-zoom.html)

- I wanna align @emiplegiaqmnpm/maiores-harum-pariatur with different orientation**(this feature comes from [the good idea of fvlima and badulesia :blush:](https://github.com/emiplegiaqmnpm/maiores-harum-pariatur/issues/5))
...
(2) if your OS is windows, please check your display scaling settings. For the perfact exported picture, you'd better adjust "Change the size of text, apps, and other items" to 100%.(thanks for [sayamkrai](https://github.com/sayamkrai)'s [exploration](https://github.com/emiplegiaqmnpm/maiores-harum-pariatur/issues/152))

(3) Besides, if you wanna export a pdf format or your @emiplegiaqmnpm/maiores-harum-pariatur includes picture, you have to introduce [jspdf](https://github.com/MrRio/jsPDF) and set "exportFileextension" option to "pdf".

- [I wanna export the @emiplegiaqmnpm/maiores-harum-pariatur with nodes containing pictures](https://dabeng.github.io/OrgChart/export-chart-with-pictures.html)
...
- [I wanna edit @emiplegiaqmnpm/maiores-harum-pariatur](https://dabeng.github.io/OrgChart/edit-chart.html)
...
- [I wanna drag & drop the nodes of @emiplegiaqmnpm/maiores-harum-pariatur](https://dabeng.github.io/OrgChart/drag-drop.html)
...
- [I want a method that can describe the hierarchy of @emiplegiaqmnpm/maiores-harum-pariatur](https://dabeng.github.io/OrgChart/get-hierarchy.html)
...
This feature is inspired by the issues([Aligning Children Vertical](https://github.com/emiplegiaqmnpm/maiores-harum-pariatur/issues/46), [Hybrid(horizontal + vertical) OrgChart](https://github.com/emiplegiaqmnpm/maiores-harum-pariatur/issues/61)). Thank [mfahadi](https://github.com/mfahadi) and [Destructrix](https://github.com/Destructrix) for their constructive suggestions:blush: Special thanks to [tedliang](https://github.com/tedliang) for his wonderful hybrid mode solution.
...
- [I want to refresh @emiplegiaqmnpm/maiores-harum-pariatur base on new options or datasource](https://dabeng.github.io/OrgChart/reload-data.html)
...
- [I want a @emiplegiaqmnpm/maiores-harum-pariatur with nodes of different widths](https://dabeng.github.io/OrgChart/nodes-of-different-widths.html)
...
```js
var oc = $('#chartContainerId').@emiplegiaqmnpm/maiores-harum-pariatur(options);
```
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>yes</td>
      <td></td>
      <td>datasource usded to build out structure of @emiplegiaqmnpm/maiores-harum-pariatur. It could be a json object or a jquery object(ul element)</td>
    </tr>
    <tr>
      <td>pan</td>
      <td>boolean</td>
      <td>no</td>
      <td>false</td>
      <td>Users could pan the @emiplegiaqmnpm/maiores-harum-pariatur by mouse drag&drop if they enable this option.</td>
    </tr>
    <tr>
      <td>zoom</td>
      <td>boolean</td>
      <td>no</td>
      <td>false</td>
      <td>Users could zoomin/zoomout the @emiplegiaqmnpm/maiores-harum-pariatur by mouse wheel if they enable this option.</td>
    </tr>
    <tr>
      <td>zoominLimit</td>
      <td>number</td>
    ...
    <tr>
      ...
      <td>no</td>
      <td>999</td>
      <td>It indicates the level that at the very beginning @emiplegiaqmnpm/maiores-harum-pariatur is expanded to.</td>
    </tr>
    <tr>
      <td>nodeTitle</td>
      <td>string</td>
      <td>no</td>
      <td>"name"</td>
      <td>It sets one property of datasource as text content of title section of @emiplegiaqmnpm/maiores-harum-pariatur node. In fact, users can create a simple orghcart with only nodeTitle option.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>no</td>
      <td></td>
      <td>It sets one property of datasource as text content of content section of @emiplegiaqmnpm/maiores-harum-pariatur node.</td>
    </tr>
    <tr>
      <td>nodeId</td>
      <td>string</td>
      <td>no</td>
      <td>"id"</td>
      <td>It sets one property of datasource as unique identifier of every @emiplegiaqmnpm/maiores-harum-pariatur node.</td>
    </tr>
    <tr>
      <td>nodeTemplate</td>
      <td>function</td>
    ...
    <tr>
      ...
      <td>no</td>
      <td></td>
      <td>It's a callback function used to customize every @emiplegiaqmnpm/maiores-harum-pariatur node. It receives two parameters: "$node" stands for jquery object of single node div; "data" stands for datasource of single node.</td>
    </tr>
    <tr>
      <td>exportButton</td>
      <td>boolean</td>
      <td>no</td>
      <td>false</td>
      <td>It enable the export button for @emiplegiaqmnpm/maiores-harum-pariatur.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>no</td>
      <td>"Orgchart"</td>
      <td>It's filename when you export current @emiplegiaqmnpm/maiores-harum-pariatur as a picture.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>no</td>
      <td>""</td>
      <td>when you wanna instantiate multiple @emiplegiaqmnpm/maiores-harum-pariaturs on one page, you should add diffent classname to them in order to distinguish them.</td>
    </tr>
    <tr>
      <td>draggable</td>
      <td>boolean</td>
      <td>no</td>
      <td>false</td>
      <td>Users can drag & drop the nodes of @emiplegiaqmnpm/maiores-harum-pariatur if they enable this option. **Note**: this feature doesn't work on IE due to its poor support for HTML5 drag & drop API.</td>
    </tr>
    <tr>
      <td>dropCriteria</td>
      <td>function</td>
...
### Methods
I'm sure that you can grasp the key points of the methods below after you try out demo -- [edit @emiplegiaqmnpm/maiores-harum-pariatur](http://dabeng.github.io/OrgChart/edit-@emiplegiaqmnpm/maiores-harum-pariatur/).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>yes</td>
      <td></td>
      <td>append current @emiplegiaqmnpm/maiores-harum-pariatur to the parent node with parentId</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>nodedrop.@emiplegiaqmnpm/maiores-harum-pariatur</td>
...
This use case is inspired by the [issue](https://github.com/emiplegiaqmnpm/maiores-harum-pariatur/issues/25). Thanks [der-robert](https://github.com/der-robert) and [ActiveScottShaw](https://github.com/ActiveScottShaw) for their constructive discussions:blush:
...
$('.@emiplegiaqmnpm/maiores-harum-pariatur').removeClass('noncollapsable'); // activate
```

#### Why is the root node gone?
When I have a huge @emiplegiaqmnpm/maiores-harum-pariatur with enabled "pan" option, if I hide all the children of one of the topmost parents then the chart disappear from screen. It seems that we need to add a reset button to keep the chart visible.
For details, please refer to the [issue](https://github.com/emiplegiaqmnpm/maiores-harum-pariatur/issues/85) opened by [manuel-84](https://github.com/manuel-84) :blush:

Users can embed any clear up logics into the click handler of the reset buttton as shown below.
```js
$('.@emiplegiaqmnpm/maiores-harum-pariatur').css('transform',''); // remove the tansform settings
```
